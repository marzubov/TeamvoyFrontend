 ...
 */
 function Draggable(table, dataArray, dataObject) {
    ...
    function drag(e) {
        ...
        console.log(e.target.parentNode.parentNode.querySelector(".drag-button"));
        if (e.target.parentNode.parentNode.parentNode.tagName == 'thead') console.log('header');
        //table.tabIndex = 0;
  ...
  function renderDragButton(){
    ...
    this.enable = function(){
        enabled = true;
        //console.log(table.rows[0].querySelector(".drag-button"));
        //table.rows[0].querySelector(".drag-button").addEventListener('mousedown', drag);
        //console.log('enabled');
    }

    this.disable = function(){
        enabled = false;
        table.rows[0].querySelector(".drag-button").removeEventListener('mousedown', drag);
